...
public class JaloGoodsTransitSumController extends BaseController
{
    ...
    {
        return toAjax(jaloGoodsTransitSumService.updateJaloGoodsTransitSum(jaloGoodsTransitSum));
    }
    ...
    {
        return toAjax(jaloGoodsTransitSumService.deleteJaloGoodsTransitSumByIds(ids));
    }
}
