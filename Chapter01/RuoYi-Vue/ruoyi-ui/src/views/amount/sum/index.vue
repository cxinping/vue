<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="sumList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="编号" align="center" prop="product" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="更新时间" prop="product">
          <el-input v-model="form.product" placeholder="请输入更新时间" />
        </el-form-item>
        <el-form-item label="合计金额汇总" prop="sumSaleableInventoryAmount">
...
<script>
import { listSum, getSum, delSum, addSum, updateSum, exportSum } from "@/api/amount/sum";
